...
class CanclingRide extends StatefulWidget {
  @override
  _CanclingRideState createState() => _CanclingRideState();
}

class _CanclingRideState extends State<CanclingRide> {
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(bottom: 0,
                right: 0,
                left: 0,
                child: Container(height: SizeConfig.heightMultiplier*35,child: BottomForCanclingRide(),decoration: BoxDecoration(
                  color: Colors.white,
