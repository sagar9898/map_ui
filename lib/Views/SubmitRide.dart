...
class SubmitRideBooking extends StatefulWidget {
  @override
  _SubmitRideBookingState createState() => _SubmitRideBookingState();
}

class _SubmitRideBookingState extends State<SubmitRideBooking> {
        ...
        body: Container(
          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(bottom:0,right: 0,left: 0,child: BottomForCompleteRide('SUBMIT')),
            ],
          ),
        ),),
